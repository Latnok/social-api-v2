...
class Init1757057012045 {
  ...
  async up(queryRunner) {
    ...
    await queryRunner.query(
      `ALTER TABLE \`posts\` ADD \`id\` bigint NOT NULL PRIMARY KEY AUTO_INCREMENT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`posts\` CHANGE \`createdAt\` \`createdAt\` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`,
    );
    await queryRunner.query(
      `ALTER TABLE \`posts\` CHANGE \`updatedAt\` \`updatedAt\` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`,
    );
    await queryRunner.query(
      `ALTER TABLE \`posts\` CHANGE \`deletedAt\` \`deletedAt\` datetime(3) NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`users\` CHANGE \`createdAt\` \`createdAt\` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`,
    );
    await queryRunner.query(
      `ALTER TABLE \`users\` CHANGE \`updatedAt\` \`updatedAt\` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_posts_authorId_createdAt\` ON \`posts\` (\`authorId\`, \`createdAt\`)`,
    );
  ...
  async down(queryRunner) {
    ...
    await queryRunner.query(
      `ALTER TABLE \`posts\` CHANGE \`updatedAt\` \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`,
    );
    await queryRunner.query(
      `ALTER TABLE \`posts\` CHANGE \`createdAt\` \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`,
    );
    await queryRunner.query(`ALTER TABLE \`posts\` DROP COLUMN \`authorId\``);
    ...
    await queryRunner.query(
      `ALTER TABLE \`posts\` CHANGE \`id\` \`id\` int NOT NULL AUTO_INCREMENT`,
    );
    await queryRunner.query(
      `ALTER TABLE \`posts\` ADD CONSTRAINT \`FK_c5a322ad12a7bf95460c958e80e\` FOREIGN KEY (\`authorId\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
