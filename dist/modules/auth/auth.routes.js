...
router.post(
  '/register',
  routeRateLimit_1.authLimiter,
  (0, validate_1.validateBody)(auth_dto_1.RegisterDto),
  auth_controller_1.register,
);
router.post(
  '/login',
  routeRateLimit_1.loginLimiter,
  (0, validate_1.validateBody)(auth_dto_1.LoginDto),
