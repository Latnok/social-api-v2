...
async function getPost(req, res) {
    ...
    const post = await (0, posts_service_1.getPostById)(req.params.id, includeAuthor, req.query.withDeleted === 'true');
...
async function create(req, res) {
    ...
    if (!title || !content)
        throw new error_1.HttpError(400, 'title and content are required');
    if (title.length > 200)
